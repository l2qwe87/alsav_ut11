...
module.exports = {
  description: "Собрать расширение ext_alsav в CFU файл через конфигуратор 1С",
  args: {
    dbPath: z.string().default("F:\\src\\one_c\\alsav_ut").describe("Путь к файловой базе данных 1С"),
    outputPath: z.string().default("ext_alsav.cfu").describe("Путь для сохранения CFU файла"),
  },
  async execute(args) {
    const { dbPath = "F:\\src\\one_c\\alsav_ut", outputPath = "ext_alsav.cfu" } = args
    ...
    try {
      ...
      const extPath = join(process.cwd(), "ext_alsav")
